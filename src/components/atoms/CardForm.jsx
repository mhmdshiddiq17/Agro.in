...
const CardForm = () => {
  return (
    <div className='bg-white w-[330px] h-[480px] rounded-3xl absolute right-[20%] inset-y-24 py-8 flex flex-col items-center'>
			<img src={Logo} alt="" />
			<h1 className='text-2xl font-semibold text-center mt-2'>Selamat Datang <br></br> Kembali di Agro.in</h1>
			...
			<div className='mt-4 flex gap-x-10'>
				...
				<Button type="PrimaryButton" text="Masuk" className="w-28 h-10"/>
			</div>
			<button type='submit' className='hover:bg-primary border-2 border-gray-400 text-sm rounded-full flex items-center gap-x-2 py-1 mt-4 px-4'><GrGoogle />Masuk Dengan Google</button>
			<p className="text-xs font-semibold text-[#8D9E9B] my-2">Belum punya akun?</p>
			<Link to={"/register"} className="font-semibold text-[#8D9E9B]">Daftar Disini</Link>
    </div>
  )
}
